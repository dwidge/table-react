  ...
  return (
    <div>
      ...
      <div>
        <input
          type="checkbox"
          checked={inlineHeaders}
          onChange={() => setinlineHeaders((v) => !v)}
        />{" "}
        inlineHeaders
      </div>
      <div>
        <input
          type="checkbox"
          checked={inlineHeadersEdit}
          onChange={() => setinlineHeadersEdit((v) => !v)}
        />{" "}
        inlineHeadersEdit
      </div>
      <div>
      ...
      <Table
        ...
        schema={{
          ...
          ae: ColumnButton(
            "ColE",
            (val, row) => setmsg("ColE - " + row.id + "/" + row.aa),
            (val, row) => row.id + "/" + row.aa
          ),
          af: ColumnRef("ColF", {
            all: [b1, b2],
            colRef: "bc",
